<template>
  <div id="app">
    <el-collapse accordion>
      <el-collapse-item>
        <template slot="title">
          <big><big><big>waf开关</big></big></big><big class="header-icon el-icon-turn-off"></big>
        </template>
        <el-row>
          <div>
            <el-col :span="4">
              <el-button type="info" plain size="small" style="width:100px" >waf总开关</el-button>
              &emsp;
              <el-switch
                style=""
                v-model="value2"
            ...
            <el-col :span="4">
              <el-button type="info" plain size="small" style="width:100px" >URL白名单</el-button>
              &emsp;
              <el-switch
                style="display: "
                v-model="value3"
            ...
            <el-col :span="4">
              <el-button type="info" plain size="small" style="width:100px" >URL过滤</el-button>
              &emsp;
              <el-switch
                style="display: "
                v-model="value4"
            ...
            <el-col :span="4">
              <el-button type="info" plain size="small" style="width:100px" @click.native="GoIpControl()">ip黑名单</el-button>
              &emsp;
              <el-switch
                style="display: "
                v-model="value5"
            ...
            <el-col :span="4">
              <el-button type="info" plain size="small" style="width:100px" >ip白名单</el-button>
              &emsp;
              <el-switch
                style="display: "
                v-model="value11"
        ...
        <el-row>
          <div>
            <el-col :span="4">
              <el-button type="info" plain size="small" style="width:100px" >GET过滤</el-button>
              &emsp;
              <el-switch
                style="display: "
                v-model="value6"
            ...
            <el-col :span="4">
              <el-button type="info" plain size="small" style="width:100px" >POST过滤</el-button>
              &emsp;
              <el-switch
                style="display: "
                v-model="value7"
            ...
            <el-col :span="4">
              <el-button type="info" plain size="small" style="width:100px" >Cookie过滤</el-button>
              &emsp;
              <el-switch
                style="display: "
                v-model="value8"
            ...
            <el-col :span="4">
              <el-button type="info" plain size="small" style="width:100px" >UA过滤</el-button>
              &emsp;
              <el-switch
                style="display: "
                v-model="value9"
            ...
            <el-col :span="4">
              <el-button type="info" plain size="small" style="width:100px" >CC攻击防御</el-button>
              &emsp;
              <el-switch
                style="display: "
                v-model="value10"
...
export default {
  ...
  methods: {
    GET_table_data () {
      var data = []
      var tabledata = { type: 'get_iplist' }
      this.$axios.post(config.iplist_api, this.$qs.stringify(tabledata)
      ).then(res => {
